...
const Footer = () => {
  return (
    <footer className="bg-[#1E2A38] py-12 px-6 text-[#E6E6E6] font-['Inter',_sans-serif]">
      <div className="container mx-auto flex justify-between items-start flex-wrap gap-8">
        {/* Quick Links */}
        <div className="flex flex-col">
          <h4 className="text-xl font-semibold text-[#FFB703] mb-4">Quick Links</h4>
          <ul className="flex flex-col gap-2">
            <li>
              <Link to="/about" className="text-[#E6E6E6] hover:text-[#2EC4B6] transition-colors duration-300">
                About Us
              </Link>
            </li>
            <li>
              <Link to="/contact" className="text-[#E6E6E6] hover:text-[#2EC4B6] transition-colors duration-300">
                Contact
              </Link>
            </li>
            <li>
              <Link to="/products" className="text-[#E6E6E6] hover:text-[#2EC4B6] transition-colors duration-300">
                Products
              </Link>
            </li>
          </ul>
        ...
        <div className="flex flex-col items-end">
          <h4 className="text-xl font-semibold text-[#FFB703] mb-4">Contact Us</h4>
          <p className="mb-2">Email: nasiphizembeta@gmail.com</p>
          <p className="mb-4">Phone: (+27)73 974-0331</p>
          <div className="flex gap-4">
            <a href="https://www.tiktok.com/@nasie325?_t=ZS-8z96uUQ1TeB&_r=1" target="_blank" rel="noopener noreferrer" className="group">
              <svg className="w-6 h-6 text-[#FFB703] group-hover:text-[#2EC4B6] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className={styles.footerBottom}>
        <p className="text-sm text-[#cccccc]">
          ...
          <a
            ...
            className="text-[#E6E6E6] underline hover:text-[#2EC4B6] transition-colors duration-300"
          >
            JAY_K
          </a>
        </p>
